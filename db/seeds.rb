...
OrderItem.create(order_id: 1,product_id: 1, order_num: 12345, product_name: "Product 1", size: "14Q", quantity: 20,original_price: 800.99,price: 800.99,status: "shipped")
OrderItem.create(order_id: 1,product_id: 2,order_num: 12345, product_name: "Product 2", size: "10A", quantity: 20,original_price: 700.99,price: 700.99,status:"shipped")
OrderItem.create(order_id: 1,product_id: 3,order_num: 12345, product_name: "Product 3", size: "10A", quantity: 20,original_price: 700.99,price: 700.99,status:"shipped")
